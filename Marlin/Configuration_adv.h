...
#define DEFAULT_MINTRAVELFEEDRATE     5.0     // (mm/s) Minimum travel feedrate. Set with M205 T.
...
#define ARC_SUPPORT                 // Disable this feature to save ~3226 bytes
  ...
  //#define ARC_SEGMENTS_PER_R    1 // Max segment length, MM_PER = Mi
...
#define FILWIDTH_CUSTOM 
  ...
  // Linear interpolation is performed between the nearest calibration points. 
